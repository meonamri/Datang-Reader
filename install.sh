...
print_msg "$YELLOW" "Please configure the following:"
echo ""
echo "1. Edit the configuration file:"
echo "   sudo nano $INSTALL_DIR/src/config.py"
echo ""
echo "2. Set your Reader credentials:"
echo "   - READER_USERNAME"
echo "   - READER_PASSWORD"
echo ""
echo "3. Configure API endpoints (after capturing from Android app):"
echo "   - API_BASE_URL"
echo "   - API_ENDPOINTS"
echo ""
echo "4. Test RFID reader:"
echo "   sudo -u $SERVICE_USER python3 $INSTALL_DIR/datang_reader.py --test-reader"
echo ""
echo "5. Login and save authentication token:"
